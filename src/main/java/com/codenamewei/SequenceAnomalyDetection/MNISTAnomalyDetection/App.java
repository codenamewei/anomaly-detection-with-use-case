package com.codenamewei.SequenceAnomalyDetection.MNISTAnomalyDetection;
...
/**
 * Anomaly Detection on MNIST using simple autoencoder
 */
public class App
{
    public static void main(String[] args) throws Exception
    {
        ...
        boolean toBinarize = false;
        DataSetIterator dataIter = new MnistDataSetIterator(batchSize, dataSetSize, toBinarize);
        ...
        while(dataIter.hasNext())
        {
            ...
            SplitTestAndTrain split = data.splitTestAndTrain(80, r);  //80/20 split (from miniBatch = 100)
        ...
        for( int i=0; i<10; i++ ) listsByDigit.put(i, new ArrayList<Pair<Double, INDArray>>());
